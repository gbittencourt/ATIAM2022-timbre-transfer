...
preTrained_loadNames = ["pretrained/2VAEs/vocal_1", "pretrained/2VAEs/string_1"]
preTrained_saveName = ["pretrained/2VAEs/vocal_1", "pretrained/2VAEs/string_1"]
writer = SummaryWriter(os.path.join('runs','2VAEs'))
