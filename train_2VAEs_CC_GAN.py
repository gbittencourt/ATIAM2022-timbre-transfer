...
preTrained_loadNames = ["pretrained/2VAEs_CC_GAN/vocal_1", "pretrained/2VAEs_CC_GAN/string_1"]
preTrained_saveName = ["pretrained/2VAEs_CC_GAN/vocal_1", "pretrained/2VAEs_CC_GAN/string_1"]
writer = SummaryWriter(os.path.join('runs','2VAEs_CC_GAN'))
